                    ...
                    <form class="form-horizontal" action="create_masjid.php" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <!-- <input class="form-control" type="text" name="<?= RequestKey::$MASJID_HISTORY ?>" value="" placeholder="Sejarah Masjid"> -->

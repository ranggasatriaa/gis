...
if(!isset($_SESSION[RequestKey::$USER_ID])) {
  ...
  if(isset($_GET[RequestKey::$MASJID_ID])){
    ...
    $masjid_old = $db->getMasjidByPlaceId($masjid_id_old);
    $place_id = $masjid_old->place_id;
  }else {
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    <form class="form-horizontal" action="create_jumat.php?masjid-id=<?=$masjid_id_old?>" method="post">
                      ...
                      <div class="form-group">
                        <input type="hidden" name="<?=RequestKey::$JUMAT_MASJID_ID?>" value="<?=$masjid_id_old?>">

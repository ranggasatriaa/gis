      ...
      <div class="col-lg-12">
        ...
        <header class="page-header">
          <div class="container-fluid col-12 row">
            <h2 class="no-margin-bottom col-8">Detail Anggota</h2>
            <a href="search.php" class="text-right col-4"><h7 > Kembali <span class="fa fa-arrow-right"></span></h7></a>
          </div>
        </header>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align:right" colspan="3">
                          <a class="pull-left btn btn-secondary btn-sm" href="search.php">Kembali</a>
